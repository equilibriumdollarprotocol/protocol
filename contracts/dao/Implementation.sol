...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        // committer reward:
        mintToAccount(msg.sender, 200e18); // 200 EQD to Deployer
        // contributor  rewards:
        mintToAccount(0x80cD8EAdFD7e7829c087EE614901820807c72633, 200e18); // 150 EQD to Airdrop
        mintToAccount(0x407D2C4AAc97511347D0678F293A1d50aD69cE11, 100e18); // 150 EQD to Team
    }
